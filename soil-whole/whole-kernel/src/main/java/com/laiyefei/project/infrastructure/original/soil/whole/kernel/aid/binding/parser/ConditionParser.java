 ...
 */
public class ConditionParser implements ExpressionVisitor, ItemsListVisitor, IAid {
    ...
    public List<Expression> getExpressList() throws Exception {
        if (Validator.notEmpty(errorMsgList)) {
            throw new Exception(StringUtil.join(errorMsgList, "; "));
        }
        return expressList;
    }
